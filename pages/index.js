      ...
      <section className="section">
        <div className="container">
          <div className="container text-center mb-16">
            <div className="animate">
              <p className="uppercase">{brands.sub_title}</p>
              {markdownify(brands.title, "h2", "mt-4 section-title")}
              {markdownify(brands.description, "p", "mt-10")}
            </div>
          </div>
          ...
          <div className="row border-y border-border py-5">
            ...
            {/*        <SwiperSlide*/}
            {/*            className=" h-20 cursor-pointer py-1 px-1 grayscale  transition hover:grayscale-0 lg:px-10"*/}
            {/*            key={"brand-" + index}*/}
            {/*        >*/}
